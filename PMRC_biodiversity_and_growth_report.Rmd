---
title: "PMRC Protocol for Plot-based Measurements of Biodiversity and Growth in Sugarbushes"
...
Maple sugaring requires maples trees, which are generally part of a forested stand. These stands are assumed to vary substantially in the structure and composition. However, there is little empirical evidence that helps us understanding the observed variability and its drivers. The following protocol is an attempt to characterize biodiversity, forest composition, and structure at the sugarbush level. We started using this protocol at the Proctor Maple Research Center in the summer of 2025. 
